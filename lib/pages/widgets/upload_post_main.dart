...
class UploadPostPageMain extends StatefulWidget {
  const UploadPostPageMain({super.key});

  @override
  _UploadPostPageMainState createState() => _UploadPostPageMainState();
}

class _UploadPostPageMainState extends State<UploadPostPageMain> {
